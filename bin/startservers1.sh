...
do
    ...
    java -classpath "$SCRIPT_DIR" -Djava.rmi.server.codebase=file://localhost/$SCRIPT_DIR/edu/duke/raft/ edu.duke.raft.StartServer 1098 "$id" "$LOG_DIR" "$CONFIG_DIR" >> $OUTPUT_FILE &
    PID="$!"
    SERVER_PIDS[$id]="$PID"
